...
** TODO Normalize before Frechet
** Learn the similarity threashold?
** TODO Add features to the X matrix before checking for similarity
*** Fourier
*** Polynomial
*** Gaussian
** Addition + weighting several metrics?
** More weight to the gripper feature?
* Compare with other baselines
** Compare segmentation with HDP-
** TODO Compare to Prados et al.
